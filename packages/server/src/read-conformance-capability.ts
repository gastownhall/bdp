 ...
 * recomputes the Read-reachable projection of the schema bundle that every
 * segment binds as `schemaReadProjection` (D29 = C, 2026-09-08); the sealed
 * artifact was migrated once, without a re-run, to carry that binding, which
 * is why this constant moved without new observations.
 *
 ...
 */
const READ_COHORT_EVIDENCE_CONSTANT = "7e18f51ae390bc74876b2757faa64a5f9a5507f5";
